...
<fieldset>
	...
	<?php 
		...
		echo $this->Form->input('Profile.msn', array('between'=>': ')).'</br>';
		echo $this->Form->input('Profile.signature', array('between'=>': ')).'</br>';
		echo $this->Form->input('Profile.description', array('between'=>': ')).'</br>';
		echo $this->Form->input('Profile.private_description', array('between'=>': ')).'</br>';
